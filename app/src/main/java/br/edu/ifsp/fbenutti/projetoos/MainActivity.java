...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addListenerOnButtonLogar();
        addListenerOnButtonRegistar();
    ...
    private void addListenerOnButtonLogar() {
    ...
    private void addListenerOnButtonRegistar() {
        ...
        btnRegistrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(MainActivity.this, CriarUserActivity.class);
                startActivity(it);
            }
        });
    ...
    public void onClick(final View view) {
        ...
        if (view == findViewById(R.id.btnSync)) {
            new AsyncTask<Void, Void, String>() {
                @Override
                protected String doInBackground(Void... params) {
                    String msg;
